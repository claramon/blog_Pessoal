...
public class UsusarioControllerTest {
	...
	@Autowired
	private TestRestTemplate testRestTemplate; // adicionou no pom
	...
	public void start() throws ParseException {
        ...
        usuario = new Usuario(0L, "Paulo Antunes", "paulo@email.com.br", "13465278", dataPost); // login 0
        
		LocalDate dataPut = LocalDate.parse("2000-07-22", DateTimeFormatter.ofPattern("yyyy-MM-dd")); // atualizando o cadastro
